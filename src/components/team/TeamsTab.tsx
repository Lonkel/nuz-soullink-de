// ───────────────────────────────────────────────────────────────
// TeamsTab – Pro Trainer eine eigene Tabelle mit Stärken & Schwächen
// ───────────────────────────────────────────────────────────────
...
/* ────── Schadensmultiplikatoren berechnen ────── */
...
export default function TeamsTab() {
  ...
  /* Pokémon nach Trainer gruppieren */
  ...
  return (
    <div className="space-y-10">
      {trainers.map(trainer => {
        ...
        return (
          <div key={trainer}>
            {/* Pokémon-Auswahl oberhalb der Tabelle */}
            <TrainerPokemonSelect trainer={trainer} />

            {/* Trainer-Team-Tabelle */}
